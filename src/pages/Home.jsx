...
const services = [
  {
    ...
    icon: <FaHome className="text-white text-4xl mb-4" aria-label="Residential Design" />,
    description:
  ...
  },
  {
    ...
    icon: <FaBuilding className="text-white text-4xl mb-4" aria-label="Commercial Spaces" />,
    description:
  ...
  },
  {
    ...
    icon: <FaCity className="text-white text-4xl mb-4" aria-label="Urban Planning" />,
  ...
  },
  {
    ...
    icon: <FaDraftingCompass className="text-white text-4xl mb-4" aria-label="Interior Concepts" />,
      ...
      <div className="bg-white text-black font-body">
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <motion.div
              ...
              transition={{ 
                float: { duration: 8, repeat: Infinity, ease: "easeInOut", delay: 2 },
            ...
            <motion.div
              ...
              transition={{ 
                float: { duration: 7, repeat: Infinity, ease: "easeInOut", delay: 1 },
          ...
          >
            ...
            >
              ...
              <motion.h1
                ...
                animate="visible"
                variants={fadeUp}
                className="text-white text-5xl md:text-7xl lg:text-8xl font-display font-bold mb-8 leading-tight text-shadow-lg"
              >
                Shaping Spaces with
              ...
              <motion.p
                ...
                custom={2}
                variants={fadeUp}
                className="text-white/90 text-xl md:text-2xl mb-12 max-w-4xl mx-auto font-light leading-relaxed"
              >
              ...
              >
                <motion.button 
                  className="btn-premium group relative bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-10 py-5 rounded-full shadow-glow hover:shadow-glow-lg transition-all duration-300 transform hover:scale-105 font-semibold text-lg min-w-[220px] overflow-hidden"
              ...
              >
                {[
                  { number: "150+", label: "Projects Completed", icon: <FaShieldAlt /> },
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20">
            ...
            >
              ...
              >
                <FaArrowDown className="text-2xl animate-bounce" aria-label="Scroll to Explore" />
              </motion.div>
            </motion.div>
          </div>
        </section>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h3 className="text-2xl font-heading font-semibold mb-6 text-black">{service.title}</h3>
        ...
        <section className="max-w-7xl mx-auto py-24 px-6 bg-gradient-to-br from-gray-50 via-white to-blue-50/30 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
            {[{
              icon: <FaLightbulb className="text-blue-500 text-5xl" aria-label="Innovative Solutions" />,
              title: "Innovative Solutions",
              text: "We approach every project with creativity, backed by technical expertise.",
              gradient: "from-yellow-400 to-orange-500"
            }, {
              icon: <FaTools className="text-blue-500 text-5xl" aria-label="Skilled Craftsmanship" />,
              title: "Skilled Craftsmanship",
              text: "Our team ensures precision in every line, curve, and finish.",
              gradient: "from-blue-400 to-cyan-500"
            }, {
              icon: <FaClock className="text-blue-500 text-5xl" aria-label="Timely Delivery" />,
              ...
              >
                <div className={`absolute top-0 left-0 w-full h-1 bg-gradient-to-r ${item.gradient} rounded-t-3xl`}></div>
                ...
                <h3 className="text-3xl font-heading font-semibold mb-6 text-black text-center">{item.title}</h3>
                <p className="text-gray-600 leading-relaxed tracking-wide text-center text-lg">{item.text}</p>
              </motion.div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 py-24 px-6 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl mx-auto relative z-10">
            {[{
              ...
              quote: "Professional, visionary, and efficient from start to finish.",
              name: "David R.",
              role: "Commercial Developer",
              rating: 5
            }, {
              quote: "They balanced creativity and practicality like no one else.",
              name: "Anjali K.",
              role: "City Planner",
              rating: 5
            }].map((item, index) => (
              ...
              >
                ...
                <p className="text-white/90 italic text-xl leading-relaxed mb-8">"{item.quote}"</p>
        ...
        <section className="py-24 px-6 relative">
          ...
          >
            ...
            <div className="absolute inset-0 opacity-20">
              <div className="absolute top-10 left-10 w-32 h-32 border-2 border-white/30 rounded-full animate-spin" style={{ animationDuration: '20s' }}></div>
              <div className="absolute bottom-10 right-10 w-40 h-40 border-2 border-white/20 rounded-full animate-spin" style={{ animationDuration: '25s', animationDirection: 'reverse' }}></div>
            ...
            <div className="relative z-10 text-center max-w-4xl mx-auto">
              ...
              <p className="text-2xl mb-12 text-white/90 leading-relaxed">Contact us to start your architectural journey with a team that values quality, innovation, and vision.</p>
